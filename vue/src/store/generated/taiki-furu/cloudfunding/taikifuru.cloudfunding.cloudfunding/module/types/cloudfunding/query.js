...
export class QueryClientImpl {
    ...
    Params(request) {
        ...
        const promise = this.rpc.request("taikifuru.cloudfunding.cloudfunding.Query", "Params", data);
        return promise.then((data) => QueryParamsResponse.decode(new Reader(data)));
    }
    Project(request) {
        const data = QueryGetProjectRequest.encode(request).finish();
        const promise = this.rpc.request("taikifuru.cloudfunding.cloudfunding.Query", "Project", data);
    ...
    ProjectAll(request) {
        ...
        const promise = this.rpc.request("taikifuru.cloudfunding.cloudfunding.Query", "ProjectAll", data);
